...
**4. AI Features**
SkillTree may use the Google Gemini API to generate personalized habit challenges from user goal or onboarding text. Do not enter sensitive personal information into AI prompts, including health information, financial information, government ID numbers, passwords, or anything you would not want processed by a third-party AI service.

**5. Ads**
SkillTree may use Google Mobile Ads / AdMob to show ads. Google and its partners may process device identifiers, advertising identifiers, ad interactions, approximate location, diagnostics, and usage data for ad delivery, fraud prevention, analytics, and/or personalization depending on your device settings, app settings, and consent choices.

**6. Payments and Subscriptions**
SkillTree Pro subscriptions are managed through the app store and RevenueCat. RevenueCat may receive purchase or subscription identifiers and entitlement status so the app can confirm whether paid features should be available.

**7. Data Retention and Deletion**
We keep account, profile, friend, and progress data for as long as needed to provide the app and maintain your account, unless you request deletion.
...
- **Render/backend hosting** for backend services.
- **Supabase/Postgres database** for cloud-synced data storage.

**9. Children and Age**
SkillTree is not directed at children under 11. If we learn that we have collected personal data from a child under 11 without appropriate permission, we will take reasonable steps to delete it.

**10. Contact**
If you have questions or want your data deleted, please contact me at behlkanav@gmail.com.
