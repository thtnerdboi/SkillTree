...
const styles = StyleSheet.create({
  ...
  brand: { fontFamily: "monospace", fontSize: 11, letterSpacing: 3, color: Colors.light.tint, fontWeight: "900", textTransform: "uppercase" },
  title: { fontSize: 28, fontWeight: "800", color: Colors.light.text, marginTop: 4 },
  card: { backgroundColor: Colors.light.card, borderRadius: 12, padding: 20, gap: 14, borderWidth: 2, borderColor: Colors.light.border },
  ...
  inviteRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: Colors.light.surfaceDeep, borderRadius: 6, paddingHorizontal: 18, paddingVertical: 14, borderWidth: 2, borderColor: `${Colors.light.tint}55` },
  ...
  input: { backgroundColor: Colors.light.surfaceDeep, borderRadius: 6, paddingHorizontal: 14, paddingVertical: 13, fontSize: 15, color: Colors.light.text, borderWidth: 2, borderColor: Colors.light.border },
  actionBtn: { backgroundColor: Colors.light.tint, borderRadius: 5, paddingVertical: 14, alignItems: "center", borderWidth: 2, borderColor: "#FFF3A3", shadowColor: Colors.light.tint, shadowOpacity: 0.25, shadowRadius: 10, shadowOffset: { width: 0, height: 3 } },
